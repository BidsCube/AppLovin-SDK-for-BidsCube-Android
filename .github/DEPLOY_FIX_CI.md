...
3. Re-run the workflow (push a new tag like `v1.0.3` or use "Run workflow" on the Actions tab). The workflow that runs will be the one from the **branch you pushed** (or the commit the tag points to).
