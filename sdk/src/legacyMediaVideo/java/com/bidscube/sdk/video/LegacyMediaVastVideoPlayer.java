...
public final class LegacyMediaVastVideoPlayer extends BidscubeVastVideoPlayer {

    private static final String TAG = "LegacyMediaVastVideo";
    ...
    public LegacyMediaVastVideoPlayer(Context context, String vastMarkup, String clickThroughRedirectUrl) {
        super(context);
    ...
    public LegacyMediaVastVideoPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void playVast(String vastTag, boolean isUrl) {
        ...
        if (isUrl) {
            handleError("Remote VAST URLs are not supported by LegacyMediaVastVideoPlayer");
            return;
        }
        ...
        videoView.setOnPreparedListener(mediaPlayer -> onPrepared(mediaPlayer));
    ...
    private void handleError(String message) {
        SDKLogger.e(TAG, "Legacy video error: " + message);
